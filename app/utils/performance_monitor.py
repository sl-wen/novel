...
class PerformanceMonitor:
    ...
    def _generate_performance_report(self):
        ...
        try:
            with self.stats_lock:
                ...
                for operation_name, stats in sorted_stats[
                    :10
                ]:  # 只显示前10个最慢的操作
                    logger.info(
                        f"操作: {operation_name} | "
    ...
    def set_thresholds(
        self, slow_query_threshold: float = None, alert_threshold: float = None
    ):
        """设置性能阈值"""
            ...
            with self.stats_lock:
                ...
                for operation_name, stats in self.stats.items():
                    export_data["stats"][operation_name] = {
                        ...
                        "percentile_95_duration_ms": stats.percentile_95_duration
                        * 1000,
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        with self.stats_lock:
            ...
            return {
                ...
                "overall_success_rate": (total_successful / max(total_operations, 1))
                * 100,
